      ...
      <div class="col-xs-12">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="col-xs-10">
              <form name="tambah" id="tambah" action="{{route('home.import')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center"><span class="modal-main-icon mdi mdi-assignment"></span>
          ...
          <form class="" action="{{route('home.hitung')}}" method="post">
            @csrf
